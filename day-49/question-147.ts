...
1. **Friend does the chore successfully (no error):** Your friend calls you back (callback execution) and tells you
 everything is done (successful result).
2. **Friend runs into trouble (error):** Your friend calls you back (callback execution) and tells you there was a 
